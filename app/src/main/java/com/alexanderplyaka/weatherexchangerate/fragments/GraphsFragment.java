...
import com.alexanderplyaka.weatherexchangerate.utils.CustomFormatter;
import com.alexanderplyaka.weatherexchangerate.utils.XFormatter;
...
public class GraphsFragment extends Fragment {
    ...
    public void onCreateOptionsMenu(Menu menu , MenuInflater inflater) {
        ...
        this.menu = menu;
        this.menu.getItem(0).setIcon(ContextCompat.getDrawable(getContext() , R.drawable.ic_radio_button_unchecked_black_24dp));
    }
    ...
    public void toggleValues() {
        if (i == 1) {
            menu.getItem(0).setIcon(ContextCompat.getDrawable(getContext() , R.drawable.ic_radio_button_unchecked_black_24dp));
            i = 0;
        }
        else {
            menu.getItem(0).setIcon(ContextCompat.getDrawable(getContext() , R.drawable.ic_radio_button_checked_black_24dp));
            i = 1;
        }
