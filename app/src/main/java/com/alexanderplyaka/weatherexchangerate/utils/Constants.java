package com.alexanderplyaka.weatherexchangerate.utils;
...
public class Constants {
    ...
    public static final String METRIC = "metric"; // для шкалы Цельсия
    public static final String IMPERIAL = "imperial"; // для шкалы Фаренгейта
    ...
    public static final String OWM_APP_ID = "0b76ae234841e07e3ea23672d9bd3a1e";

    public static final String MAIL = "alexander.varangian@gmail.com";
