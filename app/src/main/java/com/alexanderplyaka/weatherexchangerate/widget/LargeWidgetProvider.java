...
import com.alexanderplyaka.weatherexchangerate.preferences.LWPrefs;
...
import com.alexanderplyaka.weatherexchangerate.utils.WidgetProviderAlarm;
...
public class LargeWidgetProvider extends AppWidgetProvider {
    ...
    private void preLoadWeather(Context context, RemoteViews remoteViews) {
        ...
        String temperatureScale = preferences.getUnits().equals("metric") ? context.getString(R.string.c) : context.getString(R.string.f);
        String speedScale = preferences.getUnits().equals("metric") ? context.getString(R.string.mps) : context.getString(R.string.mph);
